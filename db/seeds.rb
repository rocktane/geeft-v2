...
# user = User.create(email: 'yoyo@gmail.com', password: 'pppppp', username: 'yoyo', birthday: '2000-01-01')
Gift.create(budget: 100,
            age: 30,
            genre: 'neutral',
            occasion: 'Birthday',
            relationship: 'Friend',
            interests: %w[Sport Music],
            user_id: User.first.id,
            generated_list: ["Livre sur l'astrologie",
                             ...
                             "Carnet d'adresse avec symboles astrologiques"])

Event.create(name: 'Birthday', date: '2024-07-17', description: 'My birthday', url: 'https://www.google.com',
             user_id: User.first.id, gift: Gift.first)
